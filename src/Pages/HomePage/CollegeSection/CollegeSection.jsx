...
const CollegeSection = () => {
  return (
    <section className="py-5">
      <form className="text-center px-20">
        <label
        ...
        <button
          type="submit"
          className="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-[16px] mt-3 px-5 py-2.5 text-center"
        >
          Search
        </button>
      </form>
